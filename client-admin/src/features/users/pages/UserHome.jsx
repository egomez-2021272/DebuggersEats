...
export const UserHome = () => {
  ...
  const QUICK_ACCESS = [
    {
      ...
      sub: 'Reserva tu mesa ahora',
      onClick: () => navigate('/home/reservaciones'),
    },
    {
      title: 'Ordenar al Instante',
      sub: 'Ver menús disponibles',
      onClick: () => navigate('/home/restaurantes'),
    },
    {
      title: 'Eventos Gastronómicos',
      sub: 'Noches especiales',
      onClick: () => navigate('/home/eventos'),
    },
    {
  ...
  return (
    <>
      ...
      <p
        className='text-[12px] font-bold uppercase tracking-[0.07em] mb-3'
