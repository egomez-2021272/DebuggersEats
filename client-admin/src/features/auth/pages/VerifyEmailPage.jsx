...
export const VerifyEmailPage = () => {
    ...
    return (
        <div className='flex flex-col justify-center items-center h-screen px-4' style={{ background: '#0B0B0D' }}>
            <img src={logo} alt='DebuggersEats' className='w-28 h-28 object-contain mb-4' />
            <p className='text-lg font-semibold text-center max-w-lg' style={{ color: '#fff' }} aria-live='polite'>
                {displayMessage}
            </p>
        </div>
    );
