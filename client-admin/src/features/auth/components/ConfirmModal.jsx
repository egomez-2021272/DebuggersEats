...
export const UiConfirmHost = () => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center px-4" style={{ background: 'rgba(11,11,13,0.8)', backdropFilter: 'blur(4px)' }}>
      <div
      ...
      >
        ...
        <p className="text-sm mb-6" style={{ color: '#a0a0b0' }}>{confirm.message}</p>
