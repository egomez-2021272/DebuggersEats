    ...
    return (
        ...
        >
            ...
            >
                ...
                <h2 className="text-[22px] font-extrabold text-white mb-6">
                    Dejar Comentario
                </h2>

                {/* Restaurante */}
                <div className="mb-5">
                    <label className="block text-[12px] font-semibold mb-2" style={{ color: "rgba(255,255,255,0.45)" }}>
                        Restaurante
                    </label>
                    <select
                ...
                {/* Calificación */}
                <div className="mb-5">
                    <label className="block text-[12px] font-semibold mb-2.5" style={{ color: "rgba(255,255,255,0.45)" }}>
                        Calificación
                    </label>
                ...
                <div className="flex justify-end gap-3">
                    ...
                    <button
                        ...
                        style={{
                            background: submitting || !selectedRestaurant || !rating || !comment.trim()
                                ? "rgba(255,255,255,0.07)"
                                : "var(--dbe-gradient-h)",
                            color: submitting || !selectedRestaurant || !rating || !comment.trim()
                                ? "rgba(255,255,255,0.25)"
                                : "#fff",
                            border: "none",
                            cursor: submitting || !selectedRestaurant || !rating || !comment.trim()
                                ? "not-allowed"
                                : "pointer",
                        }}
                    >
